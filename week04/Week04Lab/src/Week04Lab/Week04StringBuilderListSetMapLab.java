...
public class Week04StringBuilderListSetMapLab {
	...
	public static  void main(String[] args) {
		...
		//		Strings are immutable, and concatenting a string takes up increasing amounts of memory and can 
		//		degrade program performance, String builders only take up a single memory slot 
		//		and are mutable to do with as we need.
	...
	public static List<String> swapFirstAndLast(List<String> list){
		String ph = list.get(0);
		list.set(0, list.get(list.size()-1));
		list.set(list.size() - 1, ph);
		return list;
	}
